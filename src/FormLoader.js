...
export default class FormLoader {
  ...
  */
  deserialize(data) {
    ...
    // Iterate over the properties of the data object, note this overwrites `this`
    $.each(data, function (index, value) {

      // Find the input element in the form that has the same name as the property
      // This is a jQuery object.
      let element = that.form.find(`input[name='${index}']`);
